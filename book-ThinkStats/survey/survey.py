...
class Table(object):
   ...
   def ReadFile(self, data_dir, file_name, fields, constructor, n=None):
...
def main(name, data_dir='.'):
  ...
  print 'Number of pregnancies', len(resp.records)
